...
INPUT_IMAGE = r"C:\Users\ROG STRIX\.gemini\antigravity-ide\brain\82fe4f05-d591-4b59-9fd5-8bbfd057eab0\.user_uploaded\media_1789798482822.png"
SRC_SVG = "src/icons/bat.svg"
DIST_SVG = "dist/svg/bat.svg"
SRC_PNG = "src/png/bat.png"
DIST_PNG = "dist/png/bat.png"
DIST_PNG_1024 = "dist/png-1024/bat.png"
SHOWCASE_PNG = "showcase/png/bat.png"
TEMP_PNG = "src/png/temp_bat_build.png"
TEMP_SVG = "src/png/temp_bat_build.svg"

print(f"Loading user reference image: {INPUT_IMAGE}")
img = Image.open(INPUT_IMAGE).convert('L')
arr = np.array(img)

# Find tight bounding box of bat artwork
is_dark = arr < 180
...
# Width 430.0 on 512 corresponds to 1344px on 1600 canvas
scale_512 = 430.0 / bw
...
# 1. Clean tiny white holes (< 30px) inside black regions
...
# 2. Clean tiny black specks (< 30px) in white regions
...
normalized_svg = f'''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" width="512" height="512" data-name="bat">
...
print("Bat icon successfully updated and synchronized!")
